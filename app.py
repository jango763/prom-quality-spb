...
if option == "Вариант 1: Кадровый хаб (Mэтчинг Яндекса)":
    ...
    # ЖЕЛЕЗНЫЙ ИСПРАВЛЕННЫЙ БЛОК ГРАФИКА (Без использования квадратных скобок)
    st.write("---")
...
# ================= ВАРИАНТ 2: ШЕРИНГ-ЭКОНОМИКА (АВИТО) =================
...
# ================= ВАРИАНТ 3: СУПЕРАПП ОБРАЗОВАНИЯ (СБЕР) =================
    ...
    st.header("🎒 Концепт: Финтех-трекер и субсидирование промышленного обучение")

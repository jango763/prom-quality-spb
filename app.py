...
# ==============================================================================
# 2. ИНИЦИАЛИЗАЦИЯ СКВОЗНОЙ ОПЕРАТИВНОЙ ПАМЯТИ (Строго в корне)
# ==============================================================================
...
# ==============================================================================
# 3. НАВИГАЦИОННЫЙ ДИСПЕТЧЕР В ПАПКИ PAGES
# ==============================================================================
page_citizen = st.Page("pages/1_🎓_Гражданин_РФ.py", title="🎓 Кабинет Студента (Паспорт навыков)", icon="🎓")
page_factory = st.Page("pages/2_🏢_Производство.py", title="🏢 Личный кабинет Производства", icon="🏢")
page_association = st.Page("pages/3_🛠️_Ассоциация.py", title="🛠️ Кабинет Администратора (Аналитика)", icon="🛠️")
